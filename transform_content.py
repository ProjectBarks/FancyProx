...
SCRIPT = "(function(open) {XMLHttpRequest.prototype.open = function(method, url, async, user, pass) {open.call(this, method, rewrittenUrl, async, user, pass);};})(XMLHttpRequest.prototype.open);"
...
def TransformContent(base_url, accessed_url, content):
    ...
    #script = etree.SubElement(root.find("head"), "script")
    #script.
    #content = etree.tounicode(root, pretty_print=False, method='html')
